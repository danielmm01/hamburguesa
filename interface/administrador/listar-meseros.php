               ...
               <tr>
                ...
                while($resultado=$declaracion->fetch()){
                    ...
                    <tr>
                        ...
                        <td><a href="modificar-mesero.php?id=<?php echo $resultado[0] ?>">Modificar</a></td>
                        <td><a href="../../php/eliminar/mesero.php?id=<?php echo $resultado[0] ?>">Eliminar</a></td>
                    </tr>
                    <?php
                }
            $conexion=null;
